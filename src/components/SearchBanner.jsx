    ...
    <div>
      <div style={{ backgroundImage: 'url(' + 'https://pixabay.com/get/gd4571944d16de772fa1547bf25df512cc6a939701cdabffe41bc47265065f00c8562610131e6a01367238c1ae82c291bbdeb00ec9e97e3056d7fa1b23f4106a3_1280.jpg' + ')', }} className='h-1/2 w-screen bg-cover bg-center'>
        <div className='flex-col items-center justify-center'>
          <Navbar />
          <h1 className='text-center text-white font-bold text-3xl md:text-5xl mt-10 md:mt-20 mb-4 md:mb-7'>Your Premier Destination for <br /> Stunning Image Showcases</h1>
          <div className='flex items-center justify-center text-white'>
            <div className='flex items-center w-4/5 md:w-2/5 mt-8 md:mt-10 mb-1 backdrop-blur-[100px] border-2 border-gray-400 rounded-lg md:rounded-xl shadow-md shadow-gray-500'>
